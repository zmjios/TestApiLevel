...
#define __AVAILABILITY_TOO_NEW __attribute__((deprecated("API newer than Deployment Target."))) __attribute__((weak_import))
...
#define __AVAILABILITY_INTERNAL__MAC_10_11 __AVAILABILITY_TOO_NEW
#endif
